(function () {
  ...
  function _createModal(options) {
      ...
      ModalTemplate = '<div class="Modal__backdrop" data-dismiss="Modal"><div class="Modal__content"><div class="Modal__header" style="border-bottom: 0px"><span class="Modal__btn-close" data-dismiss="Modal" title="Закрыть">×</span></div><div class="Modal__body" data-Modal="content">{{content}}</div></div>',
      ModalHTML;
